...
import ze00.PvzCheater.compat.ActionBarCompat;
import ze00.PvzCheater.compat.ActivityCompat;
import ze00.PvzCheater.compat.AndroidCompat;
import ze00.PvzCheater.compat.MenuItemCompat;
...
import ze00.PvzCheater.util.SessionList;
import ze00.PvzCheater.util.TermSettings;
...
public class Term extends Activity implements UpdateCallback, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String EXTRA_WINDOW_ID = "ze00.PvzCheater.window_id";
    ...
    private static final String ACTION_PATH_BROADCAST = "ze00.PvzCheater.broadcast.APPEND_TO_PATH";
    private static final String ACTION_PATH_PREPEND_BROADCAST = "ze00.PvzCheater.broadcast.PREPEND_TO_PATH";
    private static final String PERMISSION_PATH_BROADCAST = "ze00.PvzCheater.permission.APPEND_TO_PATH";
    private static final String PERMISSION_PATH_PREPEND_BROADCAST = "ze00.PvzCheater.permission.PREPEND_TO_PATH";
