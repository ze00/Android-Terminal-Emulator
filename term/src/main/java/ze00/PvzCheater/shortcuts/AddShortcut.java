...
package ze00.PvzCheater.shortcuts;
...
import ze00.PvzCheater.R;
import ze00.PvzCheater.RemoteInterface;
import ze00.PvzCheater.RunShortcut;
import ze00.PvzCheater.TermDebug;
import ze00.PvzCheater.compat.AlertDialogCompat;
import ze00.PvzCheater.compat.PRNGFixes;
import ze00.PvzCheater.util.ShortcutEncryption;
       ...
       extends    android.app.Activity
{
  ...
  void makeShortcut()
  {
              ...
              new View.OnClickListener()
              {
                public void onClick(View p1)
                {
                  ...
                  File get= (lastPath==null)
                    ...
                    {
                      pickerIntent.setClass(getApplicationContext(), ze00.PvzCheater.shortcuts.FSNavigator.class)
    ...
    final ImageView img=new ImageView(context);
                    img.setImageResource(ze00.PvzCheater.R.drawable.ic_launcher);
    ...
    )
    {
      ...
      Intent wrapper= new Intent();
             ...
             else
             {
               ...
               , Intent.ShortcutIconResource.fromContext(context, ze00.PvzCheater.R.drawable.ic_launcher)
               );
             }
