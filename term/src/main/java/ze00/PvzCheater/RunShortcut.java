...
public final class RunShortcut extends RemoteInterface {
    public static final String ACTION_RUN_SHORTCUT = "ze00.PvzCheater.RUN_SHORTCUT";

    public static final String EXTRA_WINDOW_HANDLE = "ze00.PvzCheater.window_handle";
    public static final String EXTRA_SHORTCUT_COMMAND = "ze00.PvzCheater.iShortcutCommand";
