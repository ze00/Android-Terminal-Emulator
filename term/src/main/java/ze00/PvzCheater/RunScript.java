...
public final class RunScript extends RemoteInterface {
    private static final String ACTION_RUN_SCRIPT = "ze00.PvzCheater.RUN_SCRIPT";

    private static final String EXTRA_WINDOW_HANDLE = "ze00.PvzCheater.window_handle";
    private static final String EXTRA_INITIAL_COMMAND = "ze00.PvzCheater.iInitialCommand";
